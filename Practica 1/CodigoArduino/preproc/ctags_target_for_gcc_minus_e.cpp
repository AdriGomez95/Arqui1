...
if(digitalRead(9) == 0x1 && digitalRead(10) == 0x1){
    pantalla.borrar();
    for(int i=0; i<200; i++){
      pantalla.borrar();
      ...
      if(digitalRead(9) == 0x0 && digitalRead(10) == 0x1 || digitalRead(9) == 0x1 && digitalRead(10) == 0x0){
        pantalla.borrar();
        break;
      }
      delay(velocidad);
...
//------------------------------------------------------------------ MENSAJE A LA DERECHA
  if(digitalRead(9) == 0x1 && digitalRead(10) == 0x0){
    for(int i=0; i > -200; i++){
      pantalla.borrar();
...
//------------------------------------------------------------------ MENSAJE EN 1 MATRIZ
 while(digitalRead(9) == 0x0 && digitalRead(10) == 0x1){
    pantalla.borrar();
